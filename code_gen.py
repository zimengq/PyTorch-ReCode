...
from seq2seq.decoder import LSTMDecoder
...
if __name__ == '__main__':
    ...
    if args.encoder == 'bilstm':
        encoder = LSTMEncoder(args.source_vocab_size, args.word_embed_dim, args.encoder_hidden_dim, bidirectional=True,
                              dropout=args.dropout)
    else:
        encoder = LSTMEncoder(args.source_vocab_size, args.word_embed_dim, args.encoder_hidden_dim, bidirectional=False,
                              dropout=args.dropout)

    decoder = LSTMDecoder(args.decoder_hidden_dim, args.rule_embed_dim, args.node_embed_dim,
                          args.encoder_hidden_dim, args.attention_hidden_dim, dropout=args.dropout)
